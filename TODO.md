...
- [Performance] "Improve image delivery" (9–160 KiB) and "Render-blocking requests" — the render-blocking piece is now understood (see LCP finding above, it's just the one CSS file, already minimal). Image delivery itself not yet separately investigated.
