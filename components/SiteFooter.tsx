...
export default function SiteFooter() {
  return <footer>
    ...
    <div><p className="footer-label">Hours</p><p>Mon–Sat · 11 AM–10 PM<br />Sunday · Closed</p><p><Link href="/menu">Menu</Link><br/><Link href="/catering">Catering</Link><br/><Link href="/events">Starkville events</Link><br/><Link href="/starkville">Local guide</Link></p></div>
